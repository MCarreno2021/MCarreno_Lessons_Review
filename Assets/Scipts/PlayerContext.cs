...
public class RiverState : PlayerState
{
    ...
    /*private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawRay(player.transform.position, rigbody.velocity * 5);
        Gizmos.color = Color.blue;
        Gizmos.DrawCube(player.transform.position, player.transform.localScale);
    }*/
...
public class ForestState : PlayerState
{
    ...
    public override void Start()
    {
        player.transform.position = new Vector3(-20, 4f, -10);
